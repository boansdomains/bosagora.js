...
var MetamaskProvider = /** @class */ (function (_super) {
    ...
    function MetamaskProvider(ethereum) {
        ...
        if (!ethereum) {
            ...
            if (!ethereum) {
                logger.throwError("could not auto-detect global.ethereum", boa_ethers_1.ethers.errors.UNSUPPORTED_OPERATION, {
        ...
        var _account = null;
        boa_ethers_1.ethers.utils.defineReadOnly(_this, "_pollAccountFunc", function () {
            var account = null;
            if (account === _account) {
                return;
            }
...
}(boa_ethers_1.ethers.providers.Web3Provider));
