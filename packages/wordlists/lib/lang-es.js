...
function dropDiacritic(word) {
    ...
    return (0, boaproject_strings_1.toUtf8String)(Array.prototype.filter.call((0, boaproject_strings_1.toUtf8Bytes)(word.normalize("NFD").toLowerCase()), function (c) {
        return ((c >= 65 && c <= 90) || (c >= 97 && c <= 123));
    }));
}
function expand(word) {
    var output = [];
    Array.prototype.forEach.call((0, boaproject_strings_1.toUtf8Bytes)(word), function (c) {
        // Acute accent
        if (c === 47) {
            output.push(204);
            output.push(129);
    ...
    return (0, boaproject_strings_1.toUtf8String)(output);
}
