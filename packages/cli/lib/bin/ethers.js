...
function setupContext(path, context, plugin) {
    ...
    context.ethers = boa_ethers_1.ethers;
    context.version = boa_ethers_1.ethers.version;
    context.Contract = boa_ethers_1.ethers.Contract;
    context.ContractFactory = boa_ethers_1.ethers.ContractFactory;
    context.Wallet = boa_ethers_1.ethers.Wallet;
    context.providers = boa_ethers_1.ethers.providers;
    context.utils = boa_ethers_1.ethers.utils;
    context.abiCoder = boa_ethers_1.ethers.utils.defaultAbiCoder;
    context.BN = boa_ethers_1.ethers.BigNumber;
    context.BigNumber = boa_ethers_1.ethers.BigNumber;
    context.FixedNumber = boa_ethers_1.ethers.FixedNumber;
    context.getAddress = boa_ethers_1.ethers.utils.getAddress;
    context.getContractAddress = boa_ethers_1.ethers.utils.getContractAddress;
    context.getIcapAddress = boa_ethers_1.ethers.utils.getIcapAddress;
    context.arrayify = boa_ethers_1.ethers.utils.arrayify;
    context.concat = boa_ethers_1.ethers.utils.concat;
    context.hexlify = boa_ethers_1.ethers.utils.hexlify;
    context.zeroPad = boa_ethers_1.ethers.utils.zeroPad;
    context.joinSignature = boa_ethers_1.ethers.utils.joinSignature;
    context.splitSignature = boa_ethers_1.ethers.utils.splitSignature;
    context.id = boa_ethers_1.ethers.utils.id;
    context.keccak256 = boa_ethers_1.ethers.utils.keccak256;
    context.namehash = boa_ethers_1.ethers.utils.namehash;
    context.sha256 = boa_ethers_1.ethers.utils.sha256;
    context.parseEther = boa_ethers_1.ethers.utils.parseEther;
    context.parseUnits = boa_ethers_1.ethers.utils.parseUnits;
    context.formatEther = boa_ethers_1.ethers.utils.formatEther;
    context.formatUnits = boa_ethers_1.ethers.utils.formatUnits;
    context.randomBytes = boa_ethers_1.ethers.utils.randomBytes;
    context.constants = boa_ethers_1.ethers.constants;
    context.parseTransaction = boa_ethers_1.ethers.utils.parseTransaction;
    context.serializeTransaction = boa_ethers_1.ethers.utils.serializeTransaction;
    context.toUtf8Bytes = boa_ethers_1.ethers.utils.toUtf8Bytes;
    context.toUtf8String = boa_ethers_1.ethers.utils.toUtf8String;
}
...
var SandboxPlugin = /** @class */ (function (_super) {
    ...
    SandboxPlugin.prototype.run = function () {
        console.log("version: " + boa_ethers_1.ethers.version);
    ...
    FundPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, boa_ethers_1.ethers.utils.fetchJson(url).then(function (data) {
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        args.forEach(function (arg) {
                            if (boa_ethers_1.ethers.utils.isAddress(arg)) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, boa_ethers_1.ethers.utils.resolveProperties({
                    ...
                    case 2:
                        ...
                        info = {
                            "Address": address,
                            "Balance": (boa_ethers_1.ethers.utils.formatEther(balance) + " ether"),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.data = boa_ethers_1.ethers.utils.hexlify(argParser.consumeOption("data") || "0x");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        this.value = boa_ethers_1.ethers.utils.parseEther(args[1]);
                        return [2 /*return*/];
                }
            });
        });
...
var SweepPlugin = /** @class */ (function (_super) {
    ...
    SweepPlugin.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, boa_ethers_1.ethers.utils.resolveProperties({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.value = boa_ethers_1.ethers.utils.parseEther(args[0]);
                        return [4 /*yield*/, this.accounts[0].getAddress()];
                    case 2:
                        address = _a.sent();
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.dump("Wrapping ether", {
                            "From": address,
                            "Value": boa_ethers_1.ethers.utils.formatEther(this.value)
                        });
                        contract = new boa_ethers_1.ethers.Contract(WethAddress, WethAbi, this.accounts[0]);
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 2:
                        ...
                        this.contract = new boa_ethers_1.ethers.Contract(tokenAddress, Erc20Abi, this.accounts[0]);
                        _a = this;
                    ...
                    case 4:
                        _b.toAddress = _c.sent();
                        this.value = boa_ethers_1.ethers.utils.parseUnits(args[2], this.decimals);
                        return [2 /*return*/];
                }
            });
        });
                ...
                switch (_a.label) {
                    case 0:
                        info = {
                            ...
                            "Value": boa_ethers_1.ethers.utils.formatUnits(this.value, this.decimals)
                        };
                        namePromise = this.contract.name().then(function (name) {
                            ...
                            var contract = new boa_ethers_1.ethers.Contract(_this.contract.address, Erc20AltAbi, _this.contract.signer);
                            contract.name().then(function (name) {
                                info["Token Name"] = boa_ethers_1.ethers.utils.parseBytes32String(name);
                            }, function (error) {
                                throw error;
                            });
                        });
                        symbolPromise = this.contract.symbol().then(function (symbol) {
                            ...
                            contract.symbol().then(function (symbol) {
                                info["Token Symbol"] = boa_ethers_1.ethers.utils.parseBytes32String(symbol);
                            }, function (error) {
                                throw error;
                            });
                        });
            ...
            return __generator(this, function (_a) {
                ...
                result.forEach(function (contract, index) {
                    output[contract.name] = {
                        ...
                        interface: contract.interface.fragments.map(function (f) { return f.format(boa_ethers_1.ethers.utils.FormatTypes.full); }),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        factory = new boa_ethers_1.ethers.ContractFactory(codes[0].interface, codes[0].bytecode, this.accounts[0]);
                        (0, cli_1.dump)("Deploying:", {
                            Contract: codes[0].name,
                            Bytecode: codes[0].bytecode,
                            Interface: codes[0].interface.fragments.map(function (f) { return f.format(boa_ethers_1.ethers.utils.FormatTypes.full); }),
